      ...
      <Box className="dashboard-container">
        ...
        {tab === 0 && (
          <div className="content-card">
            <Typography variant="h5" className="text-gradient">About Student Performance Analytics</Typography>
              ...
              <tbody>
                {students.map((s) => (
                  <tr key={s.id}>
                    <td>{s.name}</td>
                    <td>{s.email}</td>
                    <td><Chip label={s.class} className="chip-success" /></td>
                    <td>{s.enrolled}</td>
                    <td>
        ...
        {tab === 2 && (
          <Box>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
              ...
              {/* Breakdown */}
              <div className="chart-container">
                <div className="chart-title">Assessment Breakdown</div>
                <ResponsiveContainer width="100%" height="80%">
              ...
              <div className="content-card">
                ...
                {getSuggestions(selectedStudent.subjectScores).strengths.map((s) => (
                  <Chip key={s} label={s} className="chip-success" sx={{ mr: 1, mt: 1 }} />
                ))}
              </div>
              ...
              <div className="content-card">
                ...
                {getSuggestions(selectedStudent.subjectScores).improvements.map((s) => (
                  <Chip key={s} label={s} className="chip-warning" sx={{ mr: 1, mt: 1 }} />
                ))}
              </div>
            </div>
          </Box>
        ...
        {tab === 3 && (
          <Box>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
              <div className="chart-container">
                <div className="chart-title">Overall Subject Performance</div>
